        ...
        <div class="product_wrapper">
            ...
            <div class="product_right">
                ...
                if (isset($_SESSION['USER'])) {
                    if ($USER['id'] == 2) {
                ?>
                        <a class="border_bottom edit_btn" href="?page=edit&id=<?= $product_id ?>">Редактировать</a>
                        <a class="exit" href="?page=deletecat&id=<?= $product_id ?>">Удалить</a>
                <?
                    }
                }
                ?>
                <a href="?page=order&id=<?= $product_id ?>" class="add_basket_btn btn_reg">Забронировать</a>
